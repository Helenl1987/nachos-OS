...
#define NumDiskPages	512
#define VDiskSize	(NumDiskPages * PageSize)
...
// the contents of the TLB are free to be modified by the kernel software.
	...
	unsigned int tlbmiss_times;
	unsigned int totalmemory_times;
	unsigned int pagefault_times;
